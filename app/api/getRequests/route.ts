...
export async function GET(req: NextRequest){
    if(req.method === 'GET'){
        ...
        const requestsQuery = `SELECT r.req_id, r.owner, r.sent_from, r.status, rd.req_info FROM requests as r JOIN request_details as rd on r.req_id = rd.req_id WHERE r.owner = '${usernameResult[0].username}'`
